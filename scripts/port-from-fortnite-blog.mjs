#!/usr/bin/env node
/**
 * Ports the 8 posts from ../marvel-rivals-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'marvel-rivals-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'survival-game-meta': 'session Meta',
	'zero-build-strategies': 'ranked match',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'marvel rivals intel'],
...
const file = `/* Auto-generated by scripts/port-from-marvel-rivals-blog.mjs — do not edit by hand. */
