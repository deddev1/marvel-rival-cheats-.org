...
const PAGE_META_TAILS = {
	...
	neac: { suffix: 'Patch Maintenance', focus: 'how NetEase Anti-Cheat updates are handled for Marvel Rivals cheats', altKeyword: 'NetEase Anti-Cheat bypass ESP aimbot' },
