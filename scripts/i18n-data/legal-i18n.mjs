...
export const LEGAL_I18N = {
	es: {
		...
		terms: {
			...
			sec2p2: 'Usar cheats puede violar los términos del equipo de Marvel Rivals — asumes todo riesgo de ban.',
		},
	...
	fr: {
		...
		terms: {
			...
			sec2p2: 'Utiliser des cheats peut enfreindre les conditions de l\'équipe Marvel Rivals — vous assumez tout risque de bannissement.',
		},
	...
	de: {
		...
		terms: {
			...
			sec2p2: 'Cheats können gegen die Nutzungsbedingungen des Marvel Rivals Teams verstoßen — Sie tragen das volle Ban-Risiko.',
		},
	...
	pt: {
		...
		terms: {
			...
			sec2p2: 'Usar cheats pode violar os termos da equipe Marvel Rivals — você assume todo risco de ban.',
		},
	...
	it: {
		...
		terms: {
			...
			sec2p2: 'Usare cheat può violare i termini del team Marvel Rivals — assumi tutto il rischio di ban.',
		},
	...
	nl: {
		...
		terms: {
			...
			sec2p2: 'Cheats gebruiken kan in strijd zijn met de voorwaarden van het NetEase Games — u neemt alle ban-risico\'s op u.',
		},
	...
	pl: {
		...
		terms: {
			...
			sec2p2: 'Korzystanie z cheatów może naruszać warunki zespołu Marvel Rivals — bierzesz na siebie ryzyko bana.',
		},
	...
	ru: {
		...
		terms: {
			...
			sec2p2: 'Использование читов может нарушать условия команды Marvel Rivals — вы принимаете на себя риск бана.',
		},
	...
	tr: {
		...
		terms: {
			...
			sec2p2: 'Hile kullanmak Marvel Rivals ekibi şartlarını ihlal edebilir — tüm ban riskini üstlenirsiniz.',
		},
	...
	ar: {
		...
		terms: {
			...
			sec2p2: 'استخدام الغش قد ينتهك شروط فريق Marvel Rivals — أنت تتحمل كل مخاطر الحظر.',
		},
	...
	ja: {
		...
		terms: {
			...
			sec2p2: 'チートの使用はMarvel Rivalsチームの利用規約に違反する可能性があり、BANリスクはすべて自己負担です。',
		},
	...
	ko: {
		...
		terms: {
			...
			sec2p2: '치트 사용은 Marvel Rivals 팀 약관 위반일 수 있으며 모든 밴 위험은 본인 부담입니다.',
		},
	...
	zh: {
		...
		terms: {
			h2: ['接受条款', '风险免责声明', '政策变更'],
			sec2p2: '使用作弊可能违反 Marvel Rivals 团队条款 — 您承担所有封禁风险。',
		},
	...
	hi: {
		...
		terms: {
			...
			sec2p2: 'cheat का उपयोग Marvel Rivals टीम की शर्तों का उल्लंघन हो सकता है — आप सभी ban जोखिम स्वीकार करते हैं।',
		},
	...
	id: {
		...
		terms: {
			...
			sec2p2: 'Menggunakan cheat dapat melanggar ketentuan tim Marvel Rivals — Anda menanggung semua risiko ban.',
		},
	...
	th: {
		...
		terms: {
			...
			sec2p2: 'การใช้ cheat อาจละเมิดข้อกำหนดของทีม Marvel Rivals — คุณรับความเสี่ยง ban ทั้งหมด',
		},
	...
	vi: {
		...
		terms: {
			...
			sec2p2: 'Dùng cheat có thể vi phạm điều khoản của đội Marvel Rivals — bạn chịu mọi rủi ro ban.',
		},
	...
	uk: {
		...
		terms: {
			...
			sec2p2: 'Використання читів може порушувати умови команди Marvel Rivals — ви приймаєте на себе ризик бану.',
		},
	...
	cs: {
		...
		terms: {
			...
			sec2p2: 'Používání cheatů může porušovat podmínky týmu Marvel Rivals — nesete veškeré riziko bana.',
		},
	...
	ro: {
		...
		terms: {
			...
			sec2p2: 'Folosirea cheat-urilor poate încălca termenii echipei Marvel Rivals — îți asumi tot riscul de ban.',
		},
	...
	sv: {
		...
		terms: {
			...
			sec2p2: 'Att använda cheats kan bryta mot NetEase terms — du tar all ban-risk.',
		},
