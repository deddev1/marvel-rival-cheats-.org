...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/marvel-rivals-cheats-esp.webp',
		title: 'marvel rivals cheats esp',
		caption: 'marvel rivals cheats esp wallhack',
	},
	{
		src: '/images/marvel-rivals-cheats-wallhack.webp',
		title: 'marvel rivals cheats wallhack',
		caption: 'marvel rivals cheats wallhack esp',
	},
	{
		src: '/images/marvel-rivals-cheats-aimbot.webp',
		title: 'marvel rivals cheats aimbot',
		caption: 'marvel rivals cheats aimbot soft aim',
	},
	{
		src: '/images/marvel-rivals-cheats-aimbot-view.webp',
		title: 'marvel rivals cheats aimbot',
		caption: 'marvel rivals cheats aimbot view',
	},
	{
		src: '/images/marvel-rivals-cheats-radar.webp',
		title: 'marvel rivals cheats radar',
		caption: 'marvel rivals cheats radar hack',
	},
	{
		src: '/images/marvel-rivals-cheats-match.webp',
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	...
	'marvel-rivals-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'marvel-rivals-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	updates: { title: '{primaryKeyword} live status', caption: 'Check {primaryKeyword} after a game or NetEase Anti-Cheat patch' },
